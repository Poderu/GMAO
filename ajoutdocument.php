...
if(!empty($_FILES))
{
    ...
    $file_name = $file_nameex;

    $file_dest = 'Doc/'.$file_name;
    ...
    if(move_uploaded_file($file_tmp_name, $file_dest))
    {
        ...
        $req->execute(array($file_name, $file_dest, $id, $date));
        header('Location: documentationequipement.php?id='.$id.'');
    }else{echo "dommage";}
    ...
    <body>
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-actions">
                ...
                <a class="btn btn-primary" href="documentationequipement.php?id=<?php echo $id; ?>"><span class="glyphicon glyphicon-arrow-left"></span> Retour</a>
            </div>
