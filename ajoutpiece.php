  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
        ...
        if(!empty($_POST['nom']) AND !empty($_POST['code']))
        {
            ...
            if($nomlength <= 50)
            {
                if($codelength <= 50)
                {
                    $requete = 'INSERT INTO piece (piece_code, piece_designation, piece_famille, piece_modele, piece_marque, piece_stock, idemplacement, piece_alerte, piece_prix)VALUES("'.$code.'", 
                     ...
                     for($count = 0; $count < count($_POST['fournisseurs']); $count++)
                    {
                        ...
                        $requete2 = 'INSERT INTO lien (idfournisseur, idpiece) VALUES (:fournisseur, :piece)';
                         $etat = $db->prepare($requete2);
                         $etat->execute(array(
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/js/bootstrap.min.js"></script>
                 ...
                 <div id="fields">
                   ...
                   <br />
                    ...
                    <div class="table-repsonsive">
                     <span id="error"></span>
                     <table width="250" class="table table-bordered" id="item_table" >
                      <tr>
                       <th width = "200"><select name="item_unit[]" class="form-control item_unit"><option value=""></option><?php echo fill_unit_select_box($db); ?></select></th>
