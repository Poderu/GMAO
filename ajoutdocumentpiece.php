...
if(!empty($_FILES))
{
    ...
    if(move_uploaded_file($file_tmp_name, $file_dest))
    {
        ...
        $req->execute(array($nom, $file_dest, $id, $date));
        header('Location: documentationpiece.php?id='.$id.'');
    }
    ...
    <body>
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-actions">
                ...
                <a class="btn btn-primary" href="documentationpiece.php?id=<?php echo $id; ?>"><span class="glyphicon glyphicon-arrow-left"></span> Retour</a>
            </div>
