...
<html>
    ...
    <body>
        ...
        <?php if($_SESSION['droituser'] == 2)
            ...
            <a class="btn btn-success btn-lg" href="ajoutdocumentpiece.php?id=<?php echo $id; ?>"><span class="glyphicon glyphicon-plus"></span> Ajouter un document</a></h1>
        ...
        <table class="table table-striped table-bordered avectri">
            ...
            $db = Database::connect();
            $caracteristique = $db->query('SELECT iddocument, document_nom, document_document, document_date FROM document WHERE idpiece = "'.$id.'"');
                ...
                if($_SESSION['droituser'] == 2)
            {
                ...
                if($_SESSION['droituser'] == 2)
                {
                echo '<td><a class="btn btn-default" href="supprimerequipement.php?id='.$doc['iddocument'].'&amp;repeter =" onclick="Supp(this.href); return(false);"><span class="glyphicon glyphicon-trash"></span> Supprimer</a>';
