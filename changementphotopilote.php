...
<html>
    <body>
        ...
        $photo = $db->query("SELECT idpilote, pilote_image FROM pilote WHERE idpilote ='".$id."'");
        
        $req = $db->prepare("UPDATE pilote SET pilote_image ='".$dest."' WHERE pilote.idpilote = '".$id."'");
    ...
    if (isset($_FILES['photo']['tmp_name'])) {
        ...
        if($retour) {
            ...
            header('Location: boutonvoirpilote.php?id='.$id.'');
