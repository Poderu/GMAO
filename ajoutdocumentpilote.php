...
if(!empty($_FILES))
{
    ...
    if(move_uploaded_file($file_tmp_name, $file_dest))
    {
        ...
        header('Location: documentationpilote.php?id='.$id.'');
    ...
    <body>
        ...
        <form method="POST" action="" enctype="multipart/form-data">
            ...
            <div class="form-actions">
                ...
                <a class="btn btn-primary" href="documentationpilote.php?id=<?php echo $id; ?>"><span class="glyphicon glyphicon-arrow-left"></span> Retour</a>
            </div>
